...
// This is not the classification.php created in the week 10 activity.
// This is an admin view of car classifications.
// THAT VIEW IS CALLED viewClassifications.php
// NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE
            ...
            <form action="/phpmotors/vehicles/index.php" id="classifictionForm" method="POST">
               ...
               <fieldset>
                  ...
                  <div>
                     ...
                     <input type="text" id="classificationName" name="classificationName" required <? if (isset($classificationName)) echo "value='$classificationName'" ; ?>
                     >
                  </div>
               </fieldset>
